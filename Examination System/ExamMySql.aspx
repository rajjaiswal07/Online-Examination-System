<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="ExamMySql.aspx.cs" Inherits="ExamMySql" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">MySql Exam
</asp:Content>
