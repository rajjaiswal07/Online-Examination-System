...
<asp:TextBox ID="emailid" runat="server" ControlToValidate="emailid" Height="50px"></asp:TextBox>
   ...
   <br /><br /> 
   Password:<br /><br /><asp:TextBox ID="lpassword" runat="server" 
        TextMode="Password" Height="50px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ErrorMessage="*" ControlToValidate="lpassword" ForeColor="Red"></asp:RequiredFieldValidator>
<p><a href="ForgotPassword.aspx">Forgot Password?</a>&nbsp&nbsp<a href="ChangePassword.aspx">Change Password</a></p>
    <p>
