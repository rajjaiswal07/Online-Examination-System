<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="SyllabusCpp.aspx.cs" Inherits="SyllabusC__" %>
...
<div class="container">
<h1 id="C">
            Be prepared for the below topics before giving Practice Test or Exam:</h1>
        <hr />
</div>
    <div class="container">
    <div class="col-lg-6">
        ...
        <h2>Pointers, Arrays and Structures</h2>
