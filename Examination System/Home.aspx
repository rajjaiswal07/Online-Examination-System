  ...
  <section id="main-slider" class="no-margin">
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    ...
                                    <a class="btn-slide animation animated-item-3" href="InfoCpp.aspx">Read More</a>
                                </div>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-3 col-sm-6">
                <a href="SyllabusCpp.aspx" class="thumbnail">
                    <p>
                        C++</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 wow fadeInDown">
                    <div class="skill">
                        <h2>Use of Programming and Scripting languages in present Time(2017-18)</h2>
    ...
    <footer class="row back aboutSection">
        <div class="container" id="aboutSection">
            <div  class="col-md-3 col-sm-6 col-xs-12">
                <h3>About Us</h3>
<img src="images/my_pic.png" class="img-circle img" />
                
                    <p>Programming Skills is an online </p>
                    <p>examination site founded in 2018</p>
                    <p>by Duraid Shaikh & Raj Jaiswal </p>
                    <p>for students,professionals,employees</p>
                    <p>to improve their programming. </p>
                    &nbsp;&nbsp;
                    <p><font color="#ff0000">ProgrammingSkills.com </font></p>
                
                    <p>My Blogspot:</p>
                    <p><a href="https://www.rajprogrammingskills.blogspot.in">Programming Skills</a></p>
                
                    <p>My Youtube Channel:</p>
                    <a href="https://www.youtube.com/ProgrammingSkills">Programming Skills</a>
...
<img src="images/vision.jpg"  class="img-circle img" />
                <div class="one_tweet">
                    <p>To provide you a platform where you can enhance your programming skills</p>
                ...
                <div class="one_tweet">
                    <p>To Certifed you in your knowledged programming language</p>
                </div>
            </div>
...
<img alt="contact" src="images/contactus.jpg"  class="img-circle img" />
                <p><font color="#ff0000"> rajjaiswal07.rj@gmail.com</font></p>
                <p><font color="#ff0000"> duraidshaikh86@gmail.com</font></p>
                <p><font color="#ff0000"> www.programmingskills.blogspot.in</font></p>
                <p><font color="#ff0000"> +91-7045471568</font></p>
                <p><font color="#ff0000"> +91 7208048875</font></p>
            </div>
            <div  class="col-md-3 col-sm-6 col-xs-12">
                <h3>Comming Soon</h3>
                
<img alt="comingsoon" src="images/coming soon.jpg"  class="img-circle img" />
                <div class="one_tweet">
                <p>We're comming with more languages like <font color="#ff0000"> pHp,RUBY,Python</font></p>
                </div>
                
                <div class="one_tweet">
                    <p>We always keep update the questions so you can get more Idea about questions</p>
                </div>
                <div class="one_tweet">
                    <p>
